  ...
  return (
    <main className="flex justify-center py-30 px-10">
      ...
      <section className="flex gap-10">
        ...
        <Link href="/blog" className="hover:text-blue-800 border-1 p-1">Blog</Link>
      </section>
      <br/>
      <hr/>
      <br/>
      ...
      <section>
        ...
        <ul className="leading-relaxed max-w-xl font-sans list-disc">
          <li><a className="text-blue-600" href="https://www.linkedin.com/in/malavika-g-9aa515374/">LinkenIn</a></li>
